...
function ct_replace(){
    ct_repl('body *',/800 222-10-24/gi, "800 551-93-48");
    ct_repl('body *',/.800. 222-10-24/gi, "(800) 551-93-48");
    ct_repl_a('a[href*="tel:"]','href','tel:+78005519348');
}
ct_ready(ct_replace);
window.calltouch_phone = "78005519348";            if (window['ct'] && typeof window['ct'] === 'function') {
                window['ct']('create_session', { sessionId: 336657209, siteId: 35213, modId: '2kded87y', setCookie: true, endSessionTime: 1650301219, domain: 'profidress.ru', setCtCookie: '1300000000224436671', setLkCookie: null, denialTime: 15, phones: {"131092":{"subPoolName":"\u041e\u0441\u0442\u0430\u043b\u044c\u043d\u044b\u0435","phoneId":"406295","phoneNumber":"78005519348","phoneCode":"800","phoneBody":"5519348"}} });
                        } else {
...
})(window, "ctw", {"siteId":35213,"sessionId":336657209,"pageUrl":"https:\/\/www.profidress.ru\/shop\/meditsinskaya-odezhda\/"})
        if (window['ct']) {
            ct('modules', 'widgets', 'init', {"siteId":35213,"sessionId":336657209,"sessionData":{"id":336657209,"url":"https:\/\/www.profidress.ru\/shop\/meditsinskaya-odezhda\/","source":"(direct)","medium":"(none)","utmCampaign":null,"deviceType":"desktop","pools":[{"subPoolId":131092,"phoneId":406295}],"geoCity":"yerevan","geoRegion":"yerevan","geoCountry":"am","daysSinceLastVisit":null,"geoTimezone":"Europe\/Moscow"},"widgetTypes":["callback","promotion","request","whatsapp-messenger","telegram-messenger","vk-messenger","direct-calls"],"isMobileDevice":false});
        }
